...
let initial_date_2 = new Date("2024-04-01");
let final_date_2 = new Date("2024-04-30");
...
let initial_date_3 = new Date("2024-05-01");
let final_date_3 = new Date("2024-05-31");
...
let initial_date_4 = new Date("2024-06-01");
...
let current_date_5 = new Date();
let initial_date_5 = new Date("2024-07-01");
let final_date_5 = new Date("2024-07-31");
if (current_date_5 >= initial_date_5 && current_date_5 <= final_date_5) {
  document.getElementById("week_5").style.display = "block";
} else {
